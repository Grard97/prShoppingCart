...
public class PrancingPony 
{

	public static void main(String[] args) throws FileNotFoundException, ShoppingCartException 
	{
	...
	public static Order ReadOrderFromKeyboard() throws ShoppingCartException
	{
		Scanner keyboard = new Scanner(System.in);
